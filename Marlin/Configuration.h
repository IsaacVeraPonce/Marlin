...
#define STRING_CONFIG_H_AUTHOR "(Isaac Vera ET4 SKR 1.3)" // Original author or contributor.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.4, 80.4, 403.1, 94 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -60, -45,-1.9 }
